...
units = (
    ...
    u'третье', u'четвертое', u'пятое',
    u'шестое', u'седьмое', u'восьмое', u'девятое'
)

teens = (
    u'десятое', u'одиннадцатое',
    u'двенадцатое', u'тринадцатое',
    u'четырнадцатое', u'пятнадцатое',
    u'шестнадцатое', u'семнадцатое',
    u'восемнадцатое', u'девятнадцатое'
)
